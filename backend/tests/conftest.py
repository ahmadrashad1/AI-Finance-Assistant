    ...
    async with engine.begin() as conn:
        await conn.execute(
            text(
                ...
                "finance.bank_transactions, finance.payroll_lines, finance.payroll_runs, "
                "finance.close_tasks, finance.close_periods, "
                "finance.tax_periods, finance.tax_rates, "
                "finance.budgets, finance.fixed_assets, "
                "finance.requisition_items, finance.purchase_requisitions, "
                "finance.expense_limit_policies, finance.approval_threshold_policies, "
                "finance.expense_submission_policies, finance.depreciation_policies, "
